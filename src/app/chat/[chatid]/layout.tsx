        ...
        <>
            <SidebarContext.Provider value={{ sidebar, setSidebar }}>
                <chatHistoryContext.Provider value={{ chatHistory, setChatHistory }}>
                    <div className={`${sidebar ? "translate-x-0 w-3/4 sm:w-2/6 lg:w-2/12 " : " -translate-x-100 w-0 "} ${windowSize < 768 ? "" : ""} absolute z-11 left-0 flex justify-center items-center h-screen bg-[#00FF80
                        ...
                        <div className="flex flex-col justify-between h-full items-start w-full px-2">
                            <div className="flex flex-col w-full px-2">
                                ...
                                <div
                                    ...
                                    className="hover:bg-[#270238] cursor-pointer rounded-md w-full h-8 flex gap-2 justify-start items-center">
                            ...
                            <div className="w-full flex-1 mt-2 overflow-x-auto rounded-md">
                                {(chatHistory.length !== 0) ?
                                    <div className=" inset-shadow-2xs bg-[#390f4c]">
                                        {
